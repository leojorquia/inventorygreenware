...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-8" style="color: green; font-size: large;">Add new supplier tranaction</h5>
    <div style="display: flex; justify-content: flex-end;">
       <a href="/inventory_greenware/admin/suppliertrans.php"  type="button" class="btn btn-outline-info m-1">Submit</a>
</div>
    ...
    <form>
                    <div class="mb-3">
                      <label for="inputcategoryname" class="form-label" style="color:green;">Supplier</label>
                      <input type="text" class="form-control" id="inputcategoryname" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                      <label for="inputcategorydescription" class="form-label" style="color:green;">Product</label>
                    ...
                    <div class="mb-3">
                      <label for="inputcategorydescription" class="form-label" style="color:green;">Quantity ordered</label>
                      <input type="text" class="form-control" id="inputcategorydescription" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
