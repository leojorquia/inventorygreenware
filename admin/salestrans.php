...
<div class="container-fluid" style="font-family: sans-serif;">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4" style="color: green;">Sales Transactions</h5>
            <div style="display: flex; justify-content: flex-end;">
                <a href="Add-sale-transaction.php" type="button" class="btn btn-outline-info m-1" style="background-color: green; color: white;" >Add new transaction</a>      
              </div>
                            ...
                            <table class="table text-nowrap mb-0 align-middle">
                                <thead class="text-dark" style="background-color: green;">
                                    <tr>
                                        ...
                                        <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Biller</h6>
                                        </th>
                                          <th class="border-bottom-0">
                                ...
                                <tbody>
                                  ...
                                  <?php 
                                    ...
                                    $i = 0;
                                    $salestransaction = $function->GetAllSalesTransaction();
                                    if ($salestransaction) {
                                      foreach ($salestransaction as $transaction):
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td><label></label><?=$customer;?></td>
                                         ...
                                         <td><label></label><?=$reference;?></td>
                                        <td><label></label><?=$total;?></td>
                                       <td><label></label><?=$biller;?></td>         
                                        <form method="post" action="../navigate.php">
                                        <td class="border-bottom-0">
                                            <a class="btn btn-primary" href="Edit-sale-transaction.php?saletransaction_id=<?=$saletransaction_id;?>" style=" color: white;">Update</a>
                                            <input type="hidden" name="saletransaction_id" value="<?=$saletransaction_id;?>">
                                            <button class="btn btn-info" type="submit" name="btn-delete-saletransaction">Delete</button>
                                        </td>
                                        </form>
                                    </tr>
