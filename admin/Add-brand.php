...
<div class="container-fluid">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-semibold mb-4" style="color: green;">Add new Brand</h5>
      ...
      <div class="col-lg-12 d-flex align-items-stretch"> 
        <div class="card w-100">
          <div class="card-body">
              ...
              <button class="btn btn-primary" type="submit" style="float: right;" name="btn-add-brand">Submit</button>
